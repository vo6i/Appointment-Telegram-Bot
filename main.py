#this is original repo https://github.com/AlexBaranovIT/Reservation-Telegram-bot but in my Termux it's not working,because I change code and all WORK WELL
#dclxviclan with love free software MIT
import telebot
